...
const CategoryTab = ({ category, active }) => {
  ...
  return (
    <div
      className={`px-4 py-3 font-medium text-sm cursor-pointer ${getTabStyles()} ${
        active ? "border-b-4" : ""
      }`}
    >
      {category}
...
const EmailList = ({
    ...
    return (
      <div>
        ...
        <div className="flex border-b">
          <CategoryTab category="Primary" active={true} />
          <CategoryTab category="Social" active={false} />
          <CategoryTab category="Promotions" active={false} />
        </div>
        ...
        <div className="divide-y divide-gray-100">
          {[1, 2, 3, 4, 5].map((index) => (
            ...
            >
              <div className="flex items-center space-x-4 w-52 px-2">
    ...
    return (
      <div>
        ...
        <div className="flex border-b">
          ...
          />
          <CategoryTab category="Social" active={activeCategory === "Social"} />
          <CategoryTab
            category="Promotions"
        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-lg">No messages in your {type}</p>
  ...
  return (
    <div>
      {/* Gmail-like category tabs */}
      <div className="flex border-b">
        <CategoryTab category="Primary" active={activeCategory === "Primary"} />
        <CategoryTab category="Social" active={activeCategory === "Social"} />
        <CategoryTab
          category="Promotions"
          active={activeCategory === "Promotions"}
      ...
      <div className="divide-y divide-gray-100">
        {emails.map((email) => (
          <div
            key={email.id}
            className={`flex items-center hover:shadow-md transition-all py-3 px-2 cursor-pointer ${
          ...
          >
            ...
            <div className="flex items-center space-x-4 w-52 px-2">
              ...
              >
                {email.isStarred ? (
                  <StarFilled size={18} className="text-yellow-500" />
                ) : (
            ...
            <div className="flex items-center space-x-3 ml-2 min-w-24 justify-end">
              {email.hasAttachment && (
