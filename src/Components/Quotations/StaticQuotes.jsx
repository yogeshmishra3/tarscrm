...
const StaticQuotes = () => {
  ...
  const [projectTimeline, setProjectTimeline] = useState([
    { phase: "Requirement Gathering & Planning", duration: "2-3 Days" },
    { phase: "Design & Development", duration: "5-7 Days" },
    { phase: "Testing & Review", duration: "2 Days" },
    { phase: "Final Deployment", duration: "1-2 Days" },
  ]);
  ...
  const [pricing, setPricing] = useState([
    {
      ...
      description: "Custom static website (up to 5 pages)",
      price: "2000/-",
    },
    {
      service: "Additional Pages (if needed)",
      description: "Per extra page",
      price: "3100/-",
    },
    {
  ...
  const [scopeOfWork, setScopeOfWork] = useState([
    {
      title: "Custom Design",
      description: "A professionally designed, fully responsive website.",
    },
    {
      title: "Home Page + Additional Pages",
      description:
    ...
    {
      title: "Contact Form",
      description: "Integrated contact form for customer inquiries.",
    },
    {
    ...
    {
      title: "Hosting & Domain (Optional)",
      description: "Assistance with domain registration and hosting setup.",
    },
  ]);
  ...
  const uploadPDFToCloudinary = async (pdfBlob) => {
    try {
      ...
      const response = await axios.post(
        `https://api.cloudinary.com/v1_1/ddvfsfsas/upload`, // Replace 'demo' with your cloud name
        formData,
        {
          headers: {
      ...
      return response.data.secure_url; // Return the URL of the uploaded PDF
    } catch (error) {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-2xl font-bold text-indigo-800 mb-6">
          Static Website Quotation Generator
        </h2>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    {quotation.pdfUrl ? (
                      ...
                      <PDFDownloadLink
                        ...
                        fileName={`quotation_${quotation.clientName}.pdf`}
                        className="text-indigo-600 hover:text-indigo-900"
                      >
