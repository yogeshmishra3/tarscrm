  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <Text style={styles.header}>
        OFFICE MANAGEMENT SYSTEM (OMS) QUOTATION
      </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.subbtext}>
          TARS TECHNOLOGIES will design and develop a customized Office
          Management System (OMS) to streamline office operations. The key
      ...
      <View style={styles.section}>
        ...
        <Text>
          • Customizable and scalable solutions tailored to your needs.
        </Text>
        <Text>• Secure and efficient office management system.</Text>
        <Text>• Competitive pricing with top-notch service.</Text>
        <Text>• 24/7 customer support for assistance and troubleshooting.</Text>
      </View>
...
const OMSQ = () => {
  ...
  const [pricing, setPricing] = useState([
    {
      service: "OMS Development",
      description: "Custom Office Management System",
      price: "2000/-",
    },
    {
  ...
  const [scopeOfWork, setScopeOfWork] = useState([
    {
      ...
      description:
        "Maintain employee records, attendance tracking, and payroll management.",
    },
    {
      title: "Task & Project Management",
      description: "Assign, track, and manage tasks efficiently.",
    },
    {
      title: "Document Management",
      description: "Securely store, organize, and retrieve office documents.",
    },
    {
      title: "Meeting & Scheduling System",
      description: "Calendar integration for meeting scheduling and reminders.",
    },
    {
      title: "Fast Loading Speed",
      description: "Optimized performance for a smooth user experience.",
    },
    {
      title: "Client & Vendor Management",
      description: "Keep track of client and vendor interactions.",
    },
    {
      title: "Custom Reporting",
      description: "Generate reports on office performance and operations.",
    },
    {
      title: "User Access Control",
      description: "Role-based permissions for enhanced security.",
    },
    {
      title: "Cloud Integration",
      description: "Secure access to data from any location.",
    },
  ]);
