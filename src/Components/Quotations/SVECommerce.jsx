  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <Text style={styles.header}>
        Quotation for Single Vendor E-Commerce Development
      </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.subbtext}>
          TARS TECHNOLOGIES will design and develop a single vendor e-commerce
          platform tailored to your business needs. The key features of the
      ...
      <View style={styles.section}>
        ...
        <Text>• Experienced team of web developers & designers.</Text>
        <Text>• 100% customized and responsive designs.</Text>
        <Text>• Timely project delivery and excellent customer support.</Text>
...
const QuotationGenerator = () => {
  ...
  const [projectTimeline, setProjectTimeline] = useState([
    { phase: "Requirement Gathering & Planning", duration: "3-4 Days" },
    { phase: "System Setup & Configuration:", duration: "7-10 Days" },
    { phase: "Testing & Review:", duration: "3 Day" },
  ...
  const [paymentTerms, setPaymentTerms] = useState([
    ...
    "20% After Design Approval – Upon completion of initial design phase.",
  ...
  const [pricing, setPricing] = useState([
    {
      ...
      description: "Custom single vendor e-commerce website",
      price: "2000/-",
    },
    {
    ...
    {
      service: "Domain & Hosting (Optional)",
      description: "Domain registration + 1-year hosting",
      price: "2500/-",
    },
    {
  ...
  const [scopeOfWork, setScopeOfWork] = useState([
    {
      title: "Custom Design",
      description:
        "A professionally designed, fully responsive e-commerce website.",
    },
    {
      title: "Product Management",
      description: "Ability to add, edit, and manage products easily.",
    },
    {
      title: "Shopping Cart & Checkout",
      description:
        "Secure shopping cart with multiple payment gateway integration.",
    },
    {
      title: "User Registration & Login",
      description: "Customer account creation and order tracking.",
    },
    {
      title: "SEO Optimization",
      description: "Basic on-page SEO for better search engine visibility.",
    },
    {
      title: "Mobile Responsiveness",
      description: "The website will be fully optimized for mobile devices.",
    },
    {
      title: "Order & Inventory Management",
      description: "Admin dashboard to manage orders and stock levels.",
    },
    {
      title: "Secure Payment Integration",
      description: "Payment gateways like PayPal, Razorpay, Stripe, etc.",
    },
    {
      title: "Reports & Analytics",
      description: "Sales reports and customer insights.",
    },
    {
    ...
    <div>
      <div>
        <h2 className="text-2xl font-bold text-indigo-800 mb-6">
          Single Vendor E-Commerce Development
        </h2>
