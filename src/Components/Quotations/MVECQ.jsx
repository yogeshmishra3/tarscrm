  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text>
          Note: Domain, Hosting, and Third-Party API charges are separate if not
      ...
      <View style={styles.section}>
        ...
        <Text>
          • Maintenance & support plans are available at additional cost.
        </Text>
        <Text>
          • Maximum 3 revisions included; extra revisions will be chargeable.
        </Text>
        <Text>
          • All content (images, product details, text) must be provided by the
          client.
        </Text>
      </View>
...
const MVECQ = () => {
  ...
  const [paymentTerms, setPaymentTerms] = useState([
    ...
    "30% after completing development & testing.",
  ...
  const [pricing, setPricing] = useState([
    {
      service: "Basic",
      description: "Up to 10 Vendors, Basic Features",
      price: "2000/-",
    },
    {
      service: "Standard",
      description: "20 Vendors, Advanced Analytics, Custom Features",
      price: "3100/-",
    },
    {
      service: "Premium",
      description:
        "Unlimited Vendors, AI-Based Recommendations, Full Customization",
      price: "2500/-",
    },
  ]);
  ...
  const [scopeOfWork, setScopeOfWork] = useState([
    ...
    { title: "✅ Vendor Registration & Dashboard" },
    { title: "✅ Product Management System" },
    { title: "✅ Secure Payment Gateway Integration" },
    { title: "✅ Order & Inventory Management" },
    { title: "✅ Customer Reviews & Ratings" },
    { title: "✅ Admin Panel with Advanced Analytics" },
    { title: "✅ SEO Optimization & Mobile-Friendly Design" },
    ...
    <div>
      <div>
        <h2 className="text-2xl font-bold text-indigo-800 mb-6">
          Quotation for Multi-Vendor E-Commerce Development
        </h2>
