  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <Text style={styles.header}>
        Learning Management System (LMS) Quotation
      </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.subbtext}>
          TARS TECHNOLOGIES will design and develop a comprehensive Learning
          Management System tailored to your organization’s training and
          educational needs. The key features of the system will include:
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text>• Secure and efficient learning platform.</Text>
...
const LMSQ = () => {
  ...
  const [projectTimeline, setProjectTimeline] = useState([
    { phase: "Requirement Gathering & Planning", duration: "5-7 Days" },
    { phase: "Design & Development", duration: "15-20 Days" },
    { phase: "Testing & Review", duration: "4-5 Days" },
    { phase: "Final Deployment", duration: "2 Days" },
  ]);

  // **New: Payment Terms State**
  const [paymentTerms, setPaymentTerms] = useState([
    "550% Advance Payment – To initiate the project.",
  ...
  const [scopeOfWork, setScopeOfWork] = useState([
    {
      ...
      description: "Create, manage, and organize courses efficiently.",
    },
    {
      title: "User Management",
      description: "Role-based access for students, teachers, and admins.",
    },
    {
      title: "Assessment & Quizzes",
      description: "Integrated quizzes, assignments, and automated grading.",
    },
    {
    ...
    },
    {
      ...
      description: "Support for multimedia content and live sessions.",
    },
    {
      title: "Certification & Badging",
      description: "Automated certification upon course completion.",
    },
    {
      title: "Discussion Forums",
      description: "Interactive Q&A sections for better engagement.",
    },
    {
