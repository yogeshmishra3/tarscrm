...
const QuotationDocument = ({
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <Text style={styles.header}>Quotation for Mobile App Development</Text>
      ...
      <View style={styles.section}>
        ...
        <Text>
          ...
          <Text> Proposal for Mobile App Development</Text>
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text>
          Note: Third-party API, hosting, and maintenance costs are separate.
        </Text>
      </View>
      ...
      <Text style={styles.tachrline}>
        _____________________________________________________________________________
      </Text>

      <View style={styles.section}>
        <Text style={styles.title}>Terms & Conditions</Text>
        <Text>• Maintenance plans are available at additional cost.</Text>
        <Text>
          • Maximum 3 revisions included; extra revisions will be chargeable.
        </Text>
        <Text>
          • Content (logos, images, and descriptions) must be provided by the
          client.
        </Text>
      </View>
...
const MAPQ = () => {
  ...
  const [projectTimeline, setProjectTimeline] = useState([
    { phase: "UI/UX Design & Prototyping:", duration: "10 Days" },
    { phase: "Development & Testing:", duration: "25-30 Days" },
    { phase: "Final Review & Deployment:", duration: "5 Dayy" },
  ]);

  // **New: Payment Terms State**
  const [paymentTerms, setPaymentTerms] = useState([
    "40% advance payment before project initiation.",
    "30% after development & testing.",
    "30% upon final deployment & approval.",
  ]);

  const [pricing, setPricing] = useState([
    {
      service: "Basic",
      description: "Simple App, UI/UX, Authentication",
      price: "2000/-",
    },
    {
      service: "Standard",
      description: "Medium Complexity, API, Payment Integration",
      price: "3100/-",
    },
    {
      service: "Premium",
      description: "Advanced Features, AI, Custom Dashboard",
      price: "2500/-",
    },
  ]);
  ...
  const [scopeOfWork, setScopeOfWork] = useState([
    ...
    { title: "✅ Cross-Platform Development (Android & iOS)" },
    ...
    <div>
      <div>
        <h2 className="text-2xl font-bold text-indigo-800 mb-6">
          Quotation for Mobile App Development
        </h2>
