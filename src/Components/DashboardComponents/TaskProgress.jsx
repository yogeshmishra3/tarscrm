...
const TaskProgress = () => {
  ...
  return (
    <div
      className="p-2 bg-white rounded-lg shadow-md w-full max-w-lg mx-auto md:max-w-xl lg:max-w-2xl"
      style={{ marginTop: "-12%" }}
    >
      <h3 className="text-xl font-semibold mb-4 text-center">Task Progress</h3>
