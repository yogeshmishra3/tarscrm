...
const RevenueChart = () => {
  ...
  return (
    <div className="bg-white p-2 md:p-4 rounded-lg shadow-md w-full">
      <h3 className="text-center font-semibold text-sm md:text-base lg:text-lg">
        Yearly and Monthly Revenue Overview
      </h3>

      <div className="text-center mt-2">
        <label className="mr-2 text-xs md:text-sm">Filter by:</label>
        <select
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={filteredData}>
            ...
            <XAxis dataKey="label" tick={{ fontSize: 10 }} height={30} />
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-gray-100 bg-opacity-50 flex justify-center items-center p-4 z-50">
          <div className="bg-white p-3 md:p-5 rounded-md w-full max-w-xs md:max-w-sm lg:max-w-md overflow-y-auto max-h-screen">
