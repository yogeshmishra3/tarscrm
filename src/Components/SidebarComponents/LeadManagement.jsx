...
function Leadmanagement() {
  ...
  return (
    <div className=" p-4 md:pb-5  pb-15  h-screen  overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {stages.map((stage) => (
          ...
          >
            <h3 className="text-lg font-medium mb-4 text-center bg-blue-100 py-2 rounded">
              {stage}
            </h3>
            <div className="space-y-4">
              {deals
                ...
                .map((deal) => (
                  <div
                    key={deal._id}
                    className="bg-white p-4 rounded shadow-md border border-gray-200 cursor-pointer"
        ...
        <div className="fixed inset-0 bg-gray-100 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-gray-700 mb-0.5 text-s">
                  Keyword:
                </label>
                <input
                  type="text"
                  ...
                  className="w-full p-1 text-s border border-gray-300 rounded"
                />
              </div>
