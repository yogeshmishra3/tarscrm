...
function Tasks() {
  ...
  return (
    <div className="container mx-auto p-4 relative h-screen overflow-y-auto">
      {/* Expiring Tasks Popup - Top Right Corner */}
      {isExpiringPopupOpen && expiringTasks.length > 0 && (
        <div className="absolute top-4 right-4 bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-4 w-96 shadow-lg z-50">
            ...
            >
              ...
              {tasks
                ...
                .map((task) => (
                  <div
                    key={task._id}
                    className="bg-white p-4 rounded-md shadow mb-4 cursor-move"
                    draggable
      ...
      {taskToDelete && (
        <div className="fixed inset-0 bg-gray-100 bg-opacity-75 flex items-center justify-center z-[60]">
      ...
      {isOpen && (
        ...
        >
          <div
            className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-3/4 overflow-y-auto"
            ...
            {recycleBinTasks.length > 0 ? (
              <div className="space-y-4">
                {recycleBinTasks.map((task) => (
                  <div key={task._id} className="bg-gray-100 p-4 rounded-md">
                    <h4 className="text-md font-bold mb-2">{task.taskName}</h4>
                    <p className="text-sm mb-2">{task.taskDescription}</p>
                    <p className="text-sm mb-1">
