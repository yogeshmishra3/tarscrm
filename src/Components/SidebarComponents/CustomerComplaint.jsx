    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1 sm:px-4 sm:py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 text-sm sm:text-base"
          >
      ...
      <main className="max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-6 lg:px-8">
            ...
            <div className="w-full">
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  type="text"
                  id="search"
                  className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-8 sm:pl-10 text-sm border-gray-300 rounded-md py-2 border"
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
          ...
          >
            ...
            {loading && (
              <div className="p-6 sm:p-8 text-center">
                ...
                <p className="mt-2 text-sm sm:text-base text-gray-600">Loading complaints...</p>
              </div>
            )}

            {error && (
              <div className="p-3 sm:p-4 bg-red-50 text-red-600 rounded-md m-3 sm:m-4 text-sm sm:text-base">
                {error}
              </div>
            )}
            ...
            {viewMode === "list" ? (
              <ul className="divide-y divide-gray-200">
                {filteredComplaints.map((complaint) => (
                  <li
                    key={complaint._id}
                    className={`px-3 py-3 sm:px-4 sm:py-4 hover:bg-gray-50 cursor-pointer ${
                ...
                {filteredComplaints.map((complaint) => (
                  ...
                  >
                    ...
                    <div className="mt-2 flex items-center justify-between">
                      <p className="text-xxs sm:text-xs text-gray-500 truncate">
                        {complaint.fullName}
                      </p>
                      <p className="text-xxs sm:text-xs text-gray-500 whitespace-nowrap">
                        {formatDate(complaint.createdAt)}
                      </p>
                    </div>
                  </div>
          ...
          {selectedComplaint && (
            <div className={`flex-1 bg-white rounded-lg shadow overflow-hidden ${isMobile ? 'fixed inset-0 z-50 overflow-y-auto' : ''}`}>
              {isMobile && (
                <div className="bg-white px-4 py-3 border-b border-gray-200 flex justify-between items-center">
                  <button
                    onClick={closeComplaintDetails}
                    className="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700"
                  >
                    Back
                  </button>
                  <button
              ...
              {!isMobile && (
                <div className="px-4 py-4 sm:px-6 border-b border-gray-200 flex justify-between items-center">
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={() => handleDelete(selectedComplaint._id)}
                      className="inline-flex items-center px-3 py-1 border border-transparent text-xs sm:text-sm leading-5 font-medium rounded-md text-white bg-red-600 hover:bg-red-700"
                    >
                      Delete
                    </button>
                  </div>
              ...
              <div className="px-3 py-3 sm:px-4 sm:py-4">
                  ...
                  <div>
                    ...
                    {selectedComplaint.attachment ? (
                      <a
                        ...
                        className="mt-1 text-xs sm:text-sm text-indigo-600 hover:text-indigo-500"
                      >
                        View Attachment
                      </a>
                    ) : (
                ...
                <div className="mt-4 sm:mt-6">
                  <h4 className="text-xs sm:text-sm font-medium text-gray-500">Subject</h4>
                ...
                <div className="mt-4 sm:mt-6">
                  ...
                  {useCustomStatus ? (
                    <div className="mt-1 sm:mt-2">
                      <input
                        ...
                        className="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs sm:text-sm"
                      />
                    </div>
                  ) : (
                    <div className="mt-1 sm:mt-2 flex rounded-md shadow-sm">
                      <select
                        ...
                        className="flex-1 min-w-0 block w-full px-2 py-1 sm:px-3 sm:py-2 rounded-none rounded-l-md border border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm"
                      >
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="mt-3 sm:mt-4 inline-flex items-center px-3 py-1 sm:px-4 sm:py-2 border border-transparent text-xs sm:text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
                  >
