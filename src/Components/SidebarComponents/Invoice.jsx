    ...
    <div className="container mx-auto p-4 bg-gray-50 min-h-screen">
      <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-6xl mx-auto">
        ...
        {activeTab === "createInvoice" ? (
              ...
              <div className="flex justify-end mb-6">
                <div className="w-full md:w-1/3">
                  <div className="flex justify-between border-b pb-2">
                    ...
                    <span>Rs.{formData.subtotal.toFixed(2)}</span>
                  </div>
          ...
          <div>
            <h2 className="text-xl font-bold mb-4">Previous Invoices</h2>
            <div className="mb-6">
              <div className="relative">
                  ...
                  <tbody>
                    {filteredInvoices.map((invoice) => (
                      <tr key={invoice._id} className="hover:bg-gray-50">
                        ...
                        <td className="py-3 px-4 border-b">{invoice.billTo}</td>
                        <td className="py-3 px-4 border-b">
              ...
              <button
                onClick={() => {
                  ...
                  fetch(
                    ...
                    .then((data) => {
                      if (data.success && data.latestInvoiceNumber) {
                        const latestNumberMatch =
                          data.latestInvoiceNumber.match(/TTINV-(\d+)/);
                        if (latestNumberMatch && latestNumberMatch[1]) {
                          const nextNumber =
                            parseInt(latestNumberMatch[1], 10) + 1;
                          setFormData((prev) => ({
                            ...prev,
                            invoiceNumber: `TTINV-${nextNumber}`,
                          }));
                        }
                      }
                    })
                    .catch((error) => {
                      console.error("Error getting new invoice number:", error);
                      setFormData((prev) => ({
                        ...prev,
                        invoiceNumber: "TTINV-25001",
                      }));
                    });
                  setActiveTab("createInvoice");
                }}
